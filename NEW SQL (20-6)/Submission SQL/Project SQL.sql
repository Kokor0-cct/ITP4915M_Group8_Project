...
-- Database: `ProjectDB`
DROP DATABASE IF EXISTS `itp4915m_2526_projectdatabase`;
CREATE DATABASE IF NOT EXISTS `itp4915m_2526_projectdatabase` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `itp4915m_2526_projectdatabase`;
